...
const Header: React.FC = () => {
  return (
    <header className="sticky top-0 z-50 h-16 w-full overflow-hidden border-b border-slate-900/10 backdrop-blur-[10px] dark:border-slate-50/[0.06] dark:bg-cc-dark-header-bg">
