            ...
            <CustomLink href={path}>
              <article className="space-y-2 rounded-xl p-4 transition-colors group-hover:bg-neutral-100 dark:group-hover:bg-neutral-800 xl:grid xl:grid-cols-4  xl:items-baseline xl:space-y-0">
                ...
                <div className="space-y-3 xl:col-span-3">
                  <div>
                    <h3 className="text-lg font-bold tracking-tight transition-colors sm:text-xl md:text-2xl">
                      {title}
                    </h3>
                  </div>
                  <div className="prose prose-sm max-w-none text-neutral-500 transition-colors dark:text-neutral-400 md:prose-base">
                    {description}
                  </div>
                </div>
              </article>
