...
const Header: React.FC = () => {
  return (
    <header className="overflw-hidden sticky top-0 z-50 h-16 w-full border-b border-slate-900/10 bg-cc-header backdrop-blur-[10px] transition-colors dark:border-slate-50/[0.06] dark:bg-cc-dark-header-bg">
