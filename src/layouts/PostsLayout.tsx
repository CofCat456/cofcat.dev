        ...
        <div className="space-y-2 pt-10 pb-6 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <input
              ...
              placeholder="搜尋標題或內文"
              className="block w-full rounded-md border border-neutral-300 bg-white px-4 py-2 text-neutral-900 focus:border-sky-500 focus:ring-sky-500 dark:border-neutral-900 dark:bg-neutral-800 dark:text-neutral-100"
            />
            <svg
